''
' Composite Layers Example - Merge multiple ASEPRITE layers
...
PRINT "=== ASEPRITE COMPOSITE LAYERS EXAMPLE ==="
...
FOR i = 0 TO 9
    ...
    IF layer_image <> -1 THEN
        layer_count = layer_count + 1
        PRINT "- Layer "; i; ": Loaded ("; _WIDTH(layer_image); "x"; _HEIGHT(layer_image); ")"
    ...
    ELSE
        PRINT "- Layer "; i; ": Not found or no data"
    END IF
NEXT i
