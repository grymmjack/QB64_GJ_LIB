...
colorLevels = 8     ' Default color levels (2-256)
...
DO
    ...
    IF colorLevels <> oldColorLevels THEN
        ...
        _PRINTSTRING (10, 30), "Color Levels: " + STR$(colorLevels) + " (2-256)"
    ...
    SELECT CASE k
        CASE "+", "="
            IF colorLevels < 256 THEN colorLevels = colorLevels + 2
        CASE "-"
            IF colorLevels > 2 THEN colorLevels = colorLevels - 2
        CASE "r", "R"
            colorLevels = 8
    END SELECT
